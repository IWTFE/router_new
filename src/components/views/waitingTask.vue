      ...
      <el-row>
        ...
        <el-col :span="14" :offset="2">
          <div class="export_div">
            <el-button type="primary" class='resetBtn' @click="open2">答复</el-button>
            <el-button type="primary" class='resetBtn'>工单处理</el-button>
            <el-button type="primary" class='resetBtn' @click='dialogTableVisible=true'>工单详情</el-button>
            <!-- 弹出框-->
            <el-dialog title="工单详情" v-model="dialogTableVisible" size='full'>
            ...
            <el-dialog title="工单轨迹" v-model="dialogTableVisible1" size='full'>
